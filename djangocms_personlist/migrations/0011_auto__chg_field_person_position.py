...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djangocms_personlist_person', 'position', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Person.position'
        db.alter_column(u'djangocms_personlist_person', 'position', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
