...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'djangocms_personlist_person', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Team.active'
        db.delete_column(u'djangocms_personlist_team', 'active')


    def backwards(self, orm):
        # Deleting field 'Person.active'
        db.delete_column(u'djangocms_personlist_person', 'active')

        # Adding field 'Team.active'
        db.add_column(u'djangocms_personlist_team', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
