...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.ordering'
        db.add_column(u'djangocms_personlist_membership', 'ordering',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.ordering'
        db.delete_column(u'djangocms_personlist_membership', 'ordering')
