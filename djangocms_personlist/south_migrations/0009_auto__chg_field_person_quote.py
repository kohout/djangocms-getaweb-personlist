...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.quote'
        db.alter_column(u'djangocms_personlist_person', 'quote', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Person.quote'
        db.alter_column(u'djangocms_personlist_person', 'quote', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
