...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'djangocms_personlist_person', 'middle_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.alias'
        db.add_column(u'djangocms_personlist_person', 'alias',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.city'
        db.add_column(u'djangocms_personlist_person', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.www'
        db.add_column(u'djangocms_personlist_person', 'www',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.hobbies'
        db.add_column(u'djangocms_personlist_person', 'hobbies',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.quote'
        db.add_column(u'djangocms_personlist_person', 'quote',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'djangocms_personlist_person', 'middle_name')

        # Deleting field 'Person.alias'
        db.delete_column(u'djangocms_personlist_person', 'alias')

        # Deleting field 'Person.city'
        db.delete_column(u'djangocms_personlist_person', 'city')

        # Deleting field 'Person.www'
        db.delete_column(u'djangocms_personlist_person', 'www')

        # Deleting field 'Person.hobbies'
        db.delete_column(u'djangocms_personlist_person', 'hobbies')

        # Deleting field 'Person.quote'
        db.delete_column(u'djangocms_personlist_person', 'quote')
    ...
    models = {
        ...
        u'djangocms_personlist.person': {
            ...
            'quote': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
