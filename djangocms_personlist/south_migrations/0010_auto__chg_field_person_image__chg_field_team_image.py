...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djangocms_personlist_person', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

        # Changing field 'Team.image'
        db.alter_column(u'djangocms_personlist_team', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Person.image'
        db.alter_column(u'djangocms_personlist_person', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Team.image'
        db.alter_column(u'djangocms_personlist_team', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
